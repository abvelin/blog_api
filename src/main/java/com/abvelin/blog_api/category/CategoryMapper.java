...
public class CategoryMapper {
    public static Category_with_posts_dto toDto(Category category){
    ...
    public static Category toEntity(Category_with_posts_dto category_dto){
        Category category = new Category();
        category.setId(category_dto.getId());
        category.setName(category_dto.getName());
//        category.setDisplayOrder(category_dto.getDisplayOrder());
